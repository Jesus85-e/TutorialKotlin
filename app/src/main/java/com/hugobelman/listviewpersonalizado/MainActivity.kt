...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tema1 = Producto("Manejo de ListView",R.drawable.ilv,"Un ListView es un componente de vista de lista que nos servirá para mostrar datos, tal como puede ser una lista de contactos, lista de productos, etc.",R.drawable.odigo1)
        ...
        val tema2 = Producto("Manejo de Activities",R.drawable.activity,"Una Activity es un componente de la aplicación que contiene una pantalla con la que los usuarios pueden interactuar para realizar una acción, como marcar" +
                " un número telefónico, tomar una foto, enviar un correo electrónico o ver un mapa. A cada actividad se le asigna una ventana en la que se puede dibujar su interfaz de usuario.",R.drawable.codigo2 )
        ...
        val tema4 = Producto("Controles de Audio",R.drawable.audio,"Para implementar audio a tu App existen diferentes formas, tanto Online o local.\n" +
                "La clase MediaPlayer se puede usar para controlar la reproducción de archivos de audio/vídeo y transmisiones.\n",R.drawable.codigo3)
        val tema5 = Producto("SQLite",R.drawable.camara,"Es un motor de base de datos SQL transaccional de código abierto, ligero, autónomo, de configuración simple y sin servidor\n" +
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.itmObjetivo -> {
                mensaje= "El objetivo de esta aplicacion es mostrar el funcionamiento de diferentes temas en Kotlin"
